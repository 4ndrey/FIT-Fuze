...
+ (instancetype)splashViewWithIcon:(UIImage *)icon backgroundColor:(UIColor *)backgroundColor offset:(CGPoint)pointOffset
{
  /* This component is useless without an icon */
  NSParameterAssert(icon);
  
  return [[CBZRasterSplashView alloc] initWithIconImage:icon backgroundColor:backgroundColor offset:(CGPoint)pointOffset];
}
