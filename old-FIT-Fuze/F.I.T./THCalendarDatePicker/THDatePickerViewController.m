...
- (void) showClearButton {
    ...
    if (_clearAsToday) {
        ...
        [self.clearBtn setImage:([[[UIDevice currentDevice] systemVersion] floatValue] >= 8.0 ? [UIImage imageNamed:@"dialog_clear" inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil] : [UIImage imageNamed:@"dialog_clear"]) forState:UIControlStateNormal];
    }
}
